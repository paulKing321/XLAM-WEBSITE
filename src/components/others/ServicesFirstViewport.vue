<template>
  <div class="first">
    <div class="w-4/5 pt-56 mx-auto custom-padding first-text md:pt-60">
      <h1 class="my-4 text-4xl font-bold md:text-7xl lg:text-8xl xl:text-9xl animate__animated animate__backInDown animate__fast"><span class="red-text">O</span>ur <span class="red-text">S</span>ervices</h1>
